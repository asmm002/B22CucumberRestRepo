...
//	public void user_hit_the_post_request_with_json_data(String username, String job) throws IOException{   //String job added by me
	

@Given("^user hit the post request with \"([^\"]*)\" name and \"([^\"]*)\" job$")  
public void user_hit_the_post_request_with_name_and_job(String username, String job) throws Throwable {  //String job added by me
	    ...
	    object.put("job", job);  //added this line to get job (by me)
